...
public:
    ...
    void run() {
       int choice;
            ...
            std::cout << std::setfill(' ') << std::setw(10) << "" << std::setfill(' ');
            std::cout << "Programmed by: Ryan Morao M.  << BSCPE-2 >>\n";
            std::cout << std::setfill(' ') << std::setw(24) << "" << std::setfill(' ');
            std::cout << "Ken Espera  << BSCPE-2 >>\n";
            std::cout << std::setfill(' ') << std::setw(10) << "" << std::setfill(' ')<<'\n';
            std::cout << std::setfill('*') << std::setw(65) << "" << std::setfill(' ') << '\n';
                  do {
                        std::cout << '\n'<<std::setfill('*') << std::setw(65) << "" << std::setfill(' ') << '\n';
                        std::cout << std::setfill(' ') << std::setw(25) << "" << std::setfill(' ') << std::setw(20);
